...
(@STRING_ENTRY+0, 'Вид шмотки изменен'),
(@STRING_ENTRY+1, 'Выбранный слот пустой'),
(@STRING_ENTRY+2, 'Выбранная вещь недоступна'),
(@STRING_ENTRY+3, 'Вещь не существует'),
(@STRING_ENTRY+4, 'Вещь не существует'),
(@STRING_ENTRY+5, 'Выбранная вещь недоступна'),
(@STRING_ENTRY+6, 'У вас недостаточно денег'),
(@STRING_ENTRY+7, 'У вас недостаточно монет'),
(@STRING_ENTRY+8, 'Изменения сброшены'),
(@STRING_ENTRY+9, 'У вас нет изменений'),
(@STRING_ENTRY+10, 'Название недоступно');
