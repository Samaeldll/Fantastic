...
#define vk    "https://vk.com/fantastic_wow"
...
public:
    ...
    bool BonusCode(Player* player, Creature* creature, char const* code)
	{
        ...
        {
            ChatHandler(player->GetSession()).PSendSysMessage("|cffFFFFFFК сожалению код уже использовали, следите за новостями в нашей группе Вк https://vk.com/fantastic_wow\n%s|r", vk);
            player->PlayerTalkClass->SendCloseGossip();
            return true; 
        }
        return true;
