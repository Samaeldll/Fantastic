...
public:
    ...
    ChatCommand* GetCommands() const OVERRIDE
    {
        static ChatCommand commandTable[] =
        {
            ...
            { "eventrewone",      rbac::RBAC_PERM_COMMAND_EVENTREW_ONE,     false, &HandleEventrewOneCommand,      "", NULL },
            { "eventrewtwo",      rbac::RBAC_PERM_COMMAND_EVENTREW_TWO,     false, &HandleEventrewTwoCommand,      "", NULL },
            { "eventrewthree",    rbac::RBAC_PERM_COMMAND_EVENTREW_THREE,   false, &HandleEventrewThreeCommand,    "", NULL },
	...
	static bool HandleEventrewOneCommand(ChatHandler * handler, const char * args)
		{
			uint32 itemId = 90087;
			...
			Player* plTarget = pl->GetSelectedPlayer();
	...
	static bool HandleEventrewTwoCommand(ChatHandler * handler, const char * args)
		{
			uint32 itemId = 90087;
			char* ccount = strtok(NULL, " ");
			int32 count = 2;
	...
	static bool HandleEventrewThreeCommand(ChatHandler * handler, const char * args)
		{
			uint32 itemId = 90087;
			char* ccount = strtok(NULL, " ");
			int32 count = 1;
