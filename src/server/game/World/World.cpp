...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_CUSTOM_ARENA_AWARDS]                       = sConfigMgr->GetBoolDefault("Arena.CustomAwards", false);
    m_int_configs[CONFIG_CUSTOM_ARENA_AWARDS_CHECK_ID]               = sConfigMgr->GetIntDefault("Arena.CustomAwardsItemForCheckID", 0);
    m_int_configs[CONFIG_CUSTOM_ARENA_AWARDS_WINNER_ITEM_ID]         = sConfigMgr->GetIntDefault("Arena.CustomAwardsItemAddItemWinner", 0);
    m_int_configs[CONFIG_CUSTOM_ARENA_AWARDS_LOOSER_ITEM_ID]         = sConfigMgr->GetIntDefault("Arena.CustomAwardsItemAddItemLooser", 0);
    m_int_configs[CONFIG_CUSTOM_ARENA_AWARDS_WINNER_ITEM_COUNT]      = sConfigMgr->GetIntDefault("Arena.CustomAwardsItemAdditemWinnerCount", 1);
    m_int_configs[CONFIG_CUSTOM_ARENA_AWARDS_LOOSER_ITEM_COUNT]      = sConfigMgr->GetIntDefault("Arena.CustomAwardsItemAddItemLooserCount", 1);
...
void World::SetInitialWorldSettings()
{
    ...
    TC_LOG_INFO("server.loading", "Loading Custom Item Costs...");
    sObjectMgr->LoadCustomItemCosts();
    ...
    if (m_timers[WUPDATE_MODIFIER_ONLINE_CHARACTERS].Passed())
    {
        ...
        if (getBoolConfig(CONFIG_MODIFIER_ONLINE_CHARACTERS_ENABLE))
        {
            ...
            for (SessionMap::const_iterator itr = m_sessions.begin(); itr != m_sessions.end(); ++itr)
            {
              ...
              //Guild-Level-System (Bonus: Online)
              if (Guild* guild = session->GetPlayer()->GetGuild())
               {
                   if (guild->HasLevelForBonus(GUILD_BONUS_BADGE_ONLINE))
                       badge_count = 5;
               }


                session->GetPlayer()->AddItem(90001, badge_count);
                ChatHandler(session).PSendSysMessage(LANG_MODIFIER_ONLINE_CHARACTERS_WHISPER, badge_count); 
            }
        }
    }
...
void World::LoadGuildBonusInfo()
{
    ...
    m_req_guildLevel_xp2 = SelectReqGuildLevelForBonus(GUILD_BONUS_XP_2);
    m_req_guildLevel_speed_1 = SelectReqGuildLevelForBonus(GUILD_BONUS_SPEED_1);
    m_req_guildLevel_aura_1 = SelectReqGuildLevelForBonus(GUILD_BONUS_AURA_1);
    m_req_guildLevel_aura_2 = SelectReqGuildLevelForBonus(GUILD_BONUS_AURA_2);
    m_req_guildLevel_honor_2 = SelectReqGuildLevelForBonus(GUILD_BONUS_HONOR_2);
    m_req_guildLevel_spped_2 = SelectReqGuildLevelForBonus(GUILD_BONUS_SPEED_2);
    m_req_guildLevel_talent = SelectReqGuildLevelForBonus(GUILD_BONUS_TALENT);
    m_req_guildLevel_price_transmog = SelectReqGuildLevelForBonus(GUILD_BONUS_PRICE_TRANSMOG);
    m_req_guildLevel_price_reforging = SelectReqGuildLevelForBonus(GUILD_BONUS_PRICE_REFORGING);
    m_req_guildLevel_bg_badge_x2 = SelectReqGuildLevelForBonus(GUILD_BONUS_BG_BADGE_X2);
    m_req_guildLevel_item_tabard = SelectReqGuildLevelForBonus(GUILD_BONUS_ITEM_TABARD);
    m_req_guildLevel_badge_online = SelectReqGuildLevelForBonus(GUILD_BONUS_BADGE_ONLINE);
}
...
uint8 World::GetReqGuildLevelForBonus(uint8 guildBonus)
{
    ...
    case GUILD_BONUS_XP_2:
        return m_req_guildLevel_xp2;
        break;
    case GUILD_BONUS_SPEED_1:
        return m_req_guildLevel_speed_1;
        break;
    case GUILD_BONUS_AURA_1:
        return m_req_guildLevel_aura_1;
        break;
    case GUILD_BONUS_AURA_2:
        return m_req_guildLevel_aura_2;
        break;
    case GUILD_BONUS_HONOR_2:
        return m_req_guildLevel_honor_2;
        break;
    case GUILD_BONUS_SPEED_2:
        return m_req_guildLevel_spped_2;
        break;
    case GUILD_BONUS_TALENT:
        return m_req_guildLevel_talent;
        break;
    case GUILD_BONUS_PRICE_TRANSMOG:
        return m_req_guildLevel_price_transmog;
        break;
    case GUILD_BONUS_PRICE_REFORGING:
        return m_req_guildLevel_price_reforging;
        break;
    case GUILD_BONUS_BG_BADGE_X2:
        return m_req_guildLevel_bg_badge_x2;
        break;
    case GUILD_BONUS_ITEM_TABARD:
        return m_req_guildLevel_item_tabard;
    case GUILD_BONUS_BADGE_ONLINE:
        return m_req_guildLevel_badge_online;
        break;
    default:
        return 0;
        break;
