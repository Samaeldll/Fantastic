...
enum WorldIntConfigs
{
    ...
    CONFIG_CUSTOM_ARENA_AWARDS_CHECK_ID,
    CONFIG_CUSTOM_ARENA_AWARDS_WINNER_ITEM_ID,
    CONFIG_CUSTOM_ARENA_AWARDS_LOOSER_ITEM_ID,
    CONFIG_CUSTOM_ARENA_AWARDS_WINNER_ITEM_COUNT,
    CONFIG_CUSTOM_ARENA_AWARDS_LOOSER_ITEM_COUNT,
...
class World
{
    public:
        ...
        //Time to Boss Respawn
        time_t GetBossToRespawn() const { return m_BossToRespawn; }
    ...
    private:
        ...
        uint8 m_req_guildLevel_xp2;
        uint8 m_req_guildLevel_speed_1;
        uint8 m_req_guildLevel_aura_1;
        uint8 m_req_guildLevel_aura_2;
        uint8 m_req_guildLevel_honor_2;
        uint8 m_req_guildLevel_spped_2;
        uint8 m_req_guildLevel_talent;
        uint8 m_req_guildLevel_price_transmog;
        uint8 m_req_guildLevel_price_reforging;
        uint8 m_req_guildLevel_bg_badge_x2;
        uint8 m_req_guildLevel_item_tabard;
        uint8 m_req_guildLevel_badge_online;
};
