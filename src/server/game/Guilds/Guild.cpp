...
bool Guild::HasLevelForBonus(uint8 guildBonus)
{
    ...
    case GUILD_BONUS_SPEED_1:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_SPEED_1);
        break;
    case GUILD_BONUS_AURA_1:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_AURA_1);
        break;
    case GUILD_BONUS_AURA_2:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_AURA_2);
        break;
    case GUILD_BONUS_HONOR_2:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_HONOR_2);
        break;
    case GUILD_BONUS_SPEED_2:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_SPEED_2);
        break;
    case GUILD_BONUS_TALENT:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_TALENT);
        break;
    case GUILD_BONUS_PRICE_TRANSMOG:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_PRICE_TRANSMOG);
        break;
    case GUILD_BONUS_PRICE_REFORGING:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_PRICE_REFORGING);
        break;
    case GUILD_BONUS_BG_BADGE_X2:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_BG_BADGE_X2);
        break;
    case GUILD_BONUS_ITEM_TABARD:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_ITEM_TABARD);
        break;
    case GUILD_BONUS_BADGE_ONLINE:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_BADGE_ONLINE);
        break;
    default:
        return false;
        break;
...
void Guild::SetLevel(uint8 level, bool byCommand)
{
    ...
    char worldMsg[250];
    sprintf(worldMsg, "|cffADFF2FГильдия под названием |cffff0000\"%s\"|r |cffADFF2Fдостигла |cffff0000%d|r |cffADFF2Fуровня.", m_name.c_str(), level);
