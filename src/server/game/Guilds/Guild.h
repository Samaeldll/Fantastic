...
{
    GUILD_BONUS_XP_1 = 1,
    GUILD_BONUS_HONOR_1 = 2,
    GUILD_BONUS_XP_2 = 3,
    GUILD_BONUS_SPEED_1 = 4,
    GUILD_BONUS_AURA_1 = 5,
    GUILD_BONUS_AURA_2 = 6,
    GUILD_BONUS_HONOR_2 = 7,
    GUILD_BONUS_SPEED_2 = 8,
    GUILD_BONUS_TALENT = 9,
    GUILD_BONUS_PRICE_TRANSMOG = 10,
    GUILD_BONUS_PRICE_REFORGING = 11,
    GUILD_BONUS_BG_BADGE_X2 = 12,
    GUILD_BONUS_ITEM_TABARD = 13,
    GUILD_BONUS_BADGE_ONLINE = 14,
