...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_RELOAD_ITEM_TEMPLATET                  = 778,
    RBAC_PERM_COMMAND_RELOAD_CREATURE_TEMPLATE_ALL           = 779,

    // custom permissions 1000+

    RBAC_PERM_COMMAND_GUILD_INFO                             = 1000,
    RBAC_PERM_COMMAND_EVENTREW_ONE                           = 1001,
    RBAC_PERM_COMMAND_EVENTREW_TWO                           = 1002,
    RBAC_PERM_COMMAND_EVENTREW_THREE                         = 1003,
    RBAC_PERM_MAX
};
