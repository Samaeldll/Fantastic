...
struct ItemTemplate
{
    ...
    uint32 MaxMoneyLoot;
    uint32 FlagsCu;
    uint8 CustomBuyChance = 0;
    uint32 CustomReqHonor = 0;
    uint32 CustomReqArena = 0;
    float CustomOnlinePoints = 0;
    uint8 CustomCosts = 0;
    _CustomItemCosts CustomItemCost[9];
...
typedef UNORDERED_MAP<uint32, std::map<uint32, int32> > ItemFakeStatContainer_BETA; // custom
struct ItemLocale
{
    StringVector Name;
