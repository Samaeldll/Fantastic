...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        uint32 FreeTalent() const;
        bool CharSelectAndReplace() const;
        ...
        float GetCustomOnlinePoints() const { return m_custom_online_points; }
