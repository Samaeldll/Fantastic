...
void Player::UpdateAllCritPercentages()
{
    ...
    SetBaseModValue(CRIT_PERCENTAGE, PCT_MOD, value/8);
...
void Player::UpdateDodgePercentage()
{
    ...
    if (HasAura(26669))
     {
     SetStatFloatValue(PLAYER_DODGE_PERCENTAGE, value=value*1.2);
    }
