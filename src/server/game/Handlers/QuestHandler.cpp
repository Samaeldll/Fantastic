...
#include "../src/server/scripts/Custom/TitleMaster/xMessage.h"
...
void WorldSession::HandleQuestgiverAcceptQuestOpcode(WorldPacket& recvData)
{
	...
	if(_player && _player->xMessageScript)
		if(_player->xMessageScript->content.questId == questId)
			if(_player->xMessageScript->OnMessageAccept())
				return;
