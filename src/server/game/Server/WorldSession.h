...
class WorldSession
{
    public:
        ...
        void SetCurrentTrainer(uint32 entry) { m_CurrentTrainer = entry; }
        ...
        void SendTrainerList(uint64 guid, uint32 vendor_entry = 0);
        void SendTrainerList(uint64 guid, std::string const& strTitle, uint32 vendor_entry = 0);
