...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "item_template",                 rbac::RBAC_PERM_COMMAND_RELOAD_ITEM_TEMPLATET, true,  &HandleReloadItemPrototypesCommand,          "", NULL },
            { "creature_template_all",         rbac::RBAC_PERM_COMMAND_RELOAD_CREATURE_TEMPLATE_ALL, true,  &HandleReloadCreatureTemplateAllCommand,          "", NULL },
    ...
    {
        TC_LOG_INFO("misc", "Re-Loading Item Data...");
